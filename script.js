...
function intropy() {
document.querySelector("p").innerHTML = `<img src='images/Intropy Logo - Alternate Layout - White.png' width='50%' height='50%' class='logo'>The idea for Intropy stemmed from the book "Flow" by Mihaly Csikszentmihalyi and another book that changed my life called The Power of Habit by Charles Duhigg. In the past, I've found it challenging to feel fully engaged in whatever I'm doing. My mind begins to wander toward figuring out better ways to spend my time. This can be incredibly distracting and I can't always keep track of everything I want to accomplish which creates an unpleasant state of uncertainty. I've developed my own personal system for dealing with this, and I wanted to build something to help myself hold myself accountable.<br> Intropy does this by requesting that the user input their longterm goals before listing the habits they will need to accomplish daily in order to make the goal a reality. Once the habits have been decided, Intropy will algorithmically sort these tasks and automatically prompt you to complete each habit based on what it predicts will allow you to maintain a steady state of flow throughout the day. Install the extension to replace your New Tab page in chrome so that Intropy can gently remind you through the day what should be completed next when you become distracted.`;
