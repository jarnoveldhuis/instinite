...
function dice(){
  document.querySelector("p").innerHTML =
  "<img src='images/Logomark - Black.svg' width='50%' height='50%' class='logo'><br><h1>DICE</h1><br>A simple game of chance.";
...
function drums(){
  document.querySelector("p").innerHTML =
  "<img src='images/Logomark - Black.svg' width='50%' height='50%' class='logo'><br><h1>DRUM KIT</h1><br>A drum kit sound board. Pretty straight forward.";
