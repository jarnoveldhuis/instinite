...
function pig(){
  document.querySelector("p").innerHTML =
  "<img src='images/Logomark - Black.svg' width='50%' height='50%' class='logo'><br><h3>Pig</h3><br>A simple game of chance against a computerized opponent. Each round, roll the dice to accumalate points for your Round Score. If you get doubles, your Round Score will be wiped out and your turn will be over. Click Hold to end your turn to collect you points before this happens.";
...
function drums(){
  document.querySelector("p").innerHTML =
  "<img src='images/Logomark - Black.svg' width='50%' height='50%' class='logo'><br><h3>DRUM KIT</h3<br>A drum kit sound board I made while learning about DOM eventListening. Pretty straight forward.";
...
function wholesomeFamilyGame(){
  document.querySelector("p").innerHTML =
  "<img src='images/Logomark - Black.svg' width='50%' height='50%' class='logo'><br><h3>LAZER BRAIN</h3><br>A ridiculous take on Simon Says I made using my friends heads";
